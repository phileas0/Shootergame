...
Hinweis zu scikit-learn Notation:
...
# Scaler einmal fitten — für Gewichtspfad brauchen wir konsistente Skalierung
...
path_results = []
weight_matrix = []   # für Gewichtspfad-Plot
...
# ─────────────────────────────────────────────
# 4. Finales Modell mit optimalem λ — Evaluation
# ─────────────────────────────────────────────
...
# Vergleich: kein Regularisierung (C=1000) vs. optimal
